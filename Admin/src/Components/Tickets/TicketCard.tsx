...
const TicketCard: React.FC<TicketProp> = ({
  ...
  return (
    <div className="w-[350px] flex border-b-[1px] pb-5  gap-2.5 flex-col items-start justify-center bg-[var(--light-foreground)]  px-1 py-4 border-[#8a849570] ">
      <div className=" w-full flex items-start gap-5 justify-between">
        ...
        <h3 className="text-[13px] tracking-wider py-0.5 px-1 rounded border-[1px] text-[#247f8b] border-[#247f8b] ">
          {id}
        </h3>
