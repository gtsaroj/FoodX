    ...
    >
      ...
      <div className="flex border-t-[1px] border-[var(--dark-border)]    flex-col w-full gap-5">
        ...
        <button
          ...
          className=" py-1.5 rounded-md px-4 w-full flex justify-center items-center bg-[var(--primary-color)] text-center focus:bg-[var(--primary-dark)]    sm:hover:bg-[var(--primary-dark)]  text-white cursor-pointer tracking-wider sm:text-xl text-[16px] font-semibold"
        >
          Checkout
        </button>
