...
export const UserProfile = () => {
  ...
  const [reAuthPopUp, setReAuthPopUp] = useState<boolean>(false);
  ...
  return (
    <div className="relative flex items-center justify-center w-full h-full px-3 py-5">
      <div className="max-w-[1800px] flex justify-center items-center  p-2 flex-grow flex-col gap-12">
        ...
        <div className="flex flex-col items-center justify-center flex-grow w-full p-3">
          ...
          <div className="w-full max-w-[1200px] border border-red-400 rounded">
            <DangerZone popUp={popUp} />
          </div>
        </div>
      </div>
      {reAuthPopUp && (
        <div className="absolute w-[100vw] h-full bg-[#22222274] flex justify-center items-center">
