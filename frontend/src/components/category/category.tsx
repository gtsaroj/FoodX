...
import { getCategories, getProductsByTag } from "../../services";
import { SpecialCards } from "../card";
...
export const MenuType: React.FC = () => {
  ...
  const [initialTag, setInitialTag] = useState<Ui.Category>({
    id: "",
    image: "",
    name: "",
  });
