...
export const Selector: React.FC<SelectorPop> = ({ action, children }) => {
  ...
  return (
    <div className="w-[350px] rounded-t-xl relative group/selector py-1 gap-2 border-[1px] border-[var(--dark-border)] rounded px-2 bg-[var(--light-foreground)]">
      ...
      <div
        className={` bg-[var(--light-foreground)] rounded-t-sm p-1 overflow-auto left-0 top-[57px] z-[1000] shadow shadow-[#0000003a] rounded-b-lg absolute flex flex-col  gap-1 scroll-smooth w-full transition-all duration-300  ${
          show
