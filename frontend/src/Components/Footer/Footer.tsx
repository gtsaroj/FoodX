...
const Footer: React.FC = () => {
  return (
    <>
      <footer className="w-full h-full bg-[var(--primary-color)] text-[var(--light-text)] min-w-[100vw] place-items-center grid px-5 py-7">
        <div className="flex flex-col items-center justify-between w-full gap-5 px-3 py-5 border-b-4 border-b-[var(--light-border)] sm:flex-row">
